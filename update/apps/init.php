...
define('MW_NAME', 'Cyber Fision EMA');
...
// support forum.
defined('MW_SUPPORT_FORUM_URL') or define('MW_SUPPORT_FORUM_URL', 'https://forum.Cyber Fision.com/');

// support KB.
defined('MW_SUPPORT_KB_URL') or define('MW_SUPPORT_KB_URL', 'https://kb.Cyber Fision.com/');
