...
class GuestController extends Controller
{
    ...
    protected function _subscribeToEmailList(Customer $customer)
    {
        ...
        require_once Yii::getPathOfAlias('common.vendors.Cyber FisionApi.Autoloader') . '.php';
        Yii::registerAutoloader(array('Cyber FisionApi_Autoloader', 'autoloader'));
        
        Cyber FisionApi_Base::setConfig(new Cyber FisionApi_Config(array(
            'apiUrl'        => $apiUrl,
            'publicKey'     => $publicKey,
        ...
        $endpoint = new Cyber FisionApi_Endpoint_ListSubscribers();
