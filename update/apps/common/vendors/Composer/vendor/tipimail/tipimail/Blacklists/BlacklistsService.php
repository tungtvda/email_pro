...
class BlacklistsService {
	 ...
	 */
	public function getBounces($pageSize = null, $page = null) {
		$data = array(
			'type' => 'bounces',
			'pageSize' => $pageSize,
			'page' => $page
	 ...
	 * @throws \Tipimail\Exceptions\TipimailException
	 */
	public function getComplaints($list = null, $pageSize = null, $page = null) {
		$data = array(
			'type' => 'complaints',
			'list' => $list,
			'pageSize' => $pageSize,
	 ...
	 * @throws \Tipimail\Exceptions\TipimailException
	 */
	public function getUnsubscribers($list = null, $pageSize = null, $page = null) {
		$data = array(
			'type' => 'unsubscribes',
			'list' => $list,
			'pageSize' => $pageSize,
