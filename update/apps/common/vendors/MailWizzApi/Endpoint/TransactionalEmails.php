<?php
/**
 * This file contains the transactional emails endpoint for Cyber FisionApi PHP-SDK.
 * 
...
/**
 * Cyber FisionApi_Endpoint_TransactionalEmails handles all the API calls for transactional emails.
 * 
 * @author Serban George Cristian <cristian.serban@Cyber Fision.com>
 ...
 * @since 1.0
 */
class Cyber FisionApi_Endpoint_TransactionalEmails extends Cyber FisionApi_Base
{
    /**
