...
/**
 * Cyber FisionApi_Cache_Xcache makes use of the xcache extension in order to cache data in memory.
 * 
 ...
 * @since 1.0
 */
class Cyber FisionApi_Cache_Xcache extends Cyber FisionApi_Cache_Abstract
{
    /**
