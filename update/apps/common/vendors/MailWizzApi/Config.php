<?php
/**
 * This file contains the configuration class for the Cyber FisionApi PHP-SDK.
 *
...
/**
 * Cyber FisionApi_Config contains the configuration class that is injected at runtime into the main application.
 * 
 ...
 * @since 1.0
 */
class Cyber FisionApi_Config extends Cyber FisionApi_Base
{
    /**
