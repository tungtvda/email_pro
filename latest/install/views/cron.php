...
<form method="post">
    <div class="box box-primary">
        ...
        <div class="alert alert-info">
            If you run into issues when setting up the cron jobs, please read <a target="_blank" href="https://forum.Cyber Fision.com/threads/what-cron-jobs-are-why-do-i-need-to-add-them-and-how.3/"><em>this</em></a> article for solutions.<br />
        </div>
