        ...
        <div class="navbar-right">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    <a href="javascript:;" class="header-messages dropdown-toggle"
                       data-url="<?php echo Yii::app()->createUrl('messages/header'); ?>" data-toggle="dropdown"
                       title="<?php echo Yii::t('customers', 'Messages'); ?>">
                ...
                <li class="dropdown tasks-menu">
                    <a href="javascript;;" class="header-account-stats dropdown-toggle"
                       data-url="<?php echo Yii::app()->createUrl('account/usage'); ?>" data-toggle="dropdown"
                       title="<?php echo Yii::t('customers', 'Account usage'); ?>">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="footer">
                            <a href="javascript:;"
                               class="header-account-stats-refresh"><?php echo Yii::t('app', 'Refresh'); ?></a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span><?php echo ($fullName = Yii::app()->customer->getModel()->getFullName()) ? CHtml::encode($fullName) : Yii::t('app', 'Welcome'); ?>
                            <i class="caret"></i></span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header bg-light-blue">
                            <img src="<?php echo Yii::app()->customer->getModel()->getAvatarUrl(90, 90); ?>"
                                 class="img-circle"/>
                            <p>
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo $this->createUrl('account/index'); ?>"
                                   class="btn btn-default btn-flat"><?php echo Yii::t('app', 'My Account'); ?></a>
                            </div>
                            <div class="pull-right">
                                <a href="<?php echo $this->createUrl('account/logout'); ?>"
                                   class="btn btn-default btn-flat"><?php echo Yii::t('app', 'Logout'); ?></a>
                            </div>
                        </li>
                    </ul>
                </li>
        ...
        <section class="sidebar">
            ...
            <?php if (Yii::app()->options->get('system.common.show_customer_timeinfo', 'no') == 'yes' && version_compare(MW_VERSION, '1.3.4.4', '>=')) { ?>
                <div class="timeinfo">
                    ...
                    <div
                        class="pull-right"><?php echo Yii::app()->customer->getModel()->dateTimeFormatter->formatDateTime(); ?></div>
