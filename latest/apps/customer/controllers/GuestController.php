 ...
 *
 * @package  EMA
 * @author Serban George Cristian <cristian.serban@.com>
 * @link https://cyberfision.com/
 * @copyright 2013-2016  EMA (http://www..com)
...
class GuestController extends Controller
{
    ...
    protected function _subscribeToEmailList(Customer $customer)
    {
        ...
        require_once Yii::getPathOfAlias('common.vendors.Api.Autoloader') . '.php';
        Yii::registerAutoloader(array('Api_Autoloader', 'autoloader'));
        
        Api_Base::setConfig(new Api_Config(array(
            'apiUrl'        => $apiUrl,
            'publicKey'     => $publicKey,
        ...
        $endpoint = new Api_Endpoint_ListSubscribers();
