        ...
        <div class="box box-primary">
            <div class="box-header">
                ...
                <div class="pull-right">
                    ...
                    <?php echo CHtml::link(Yii::t('app', 'Add new'), array('email_blacklist_monitors/create'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Add new')));?>
                    <?php } ?>
                    <?php echo CHtml::link(Yii::t('app', 'Cancel'), array('email_blacklist_monitors/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Cancel')));?>
                </div>
