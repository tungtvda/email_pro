...
/**
 * Cyber FisionApi_ParamsIterator implements an interator for {@link Cyber FisionApi_Params}.
 *
 * It allows Cyber FisionApi_Params to return a new iterator for traversing the items in the map.
 * 
 ...
 */
class Cyber FisionApi_ParamsIterator implements Iterator
{
	/**
