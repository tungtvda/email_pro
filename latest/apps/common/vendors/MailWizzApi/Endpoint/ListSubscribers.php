<?php
/**
 * This file contains the lists subscribers endpoint for Cyber FisionApi PHP-SDK.
 *
...
/**
 * Cyber FisionApi_Endpoint_ListSubscribers handles all the API calls for lists subscribers.
 *
 * @author Serban George Cristian <cristian.serban@Cyber Fision.com>
 ...
 * @since 1.0
 */
class Cyber FisionApi_Endpoint_ListSubscribers extends Cyber FisionApi_Base
{
    /**
     ...
     * Please note that this is available only for Cyber Fision >= 1.3.6.2
     *
     * @param string $emailAddress
     * @return Cyber FisionApi_Http_Response
     */
