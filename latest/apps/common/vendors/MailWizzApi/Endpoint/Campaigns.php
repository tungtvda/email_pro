<?php
/**
 * This file contains the campaigns endpoint for Cyber FisionApi PHP-SDK.
 * 
...
/**
 * Cyber FisionApi_Endpoint_Campaigns handles all the API calls for campaigns.
 * 
 * @author Serban George Cristian <cristian.serban@Cyber Fision.com>
 ...
 * @since 1.0
 */
class Cyber FisionApi_Endpoint_Campaigns extends Cyber FisionApi_Base
{
    /**
