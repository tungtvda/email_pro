<?php
/**
 * This file contains the Cyber FisionApi_Http_Response class used in the Cyber FisionApi PHP-SDK.
 * 
...
/**
 * Cyber FisionApi_Http_Response is the class used to get the responses back from the API endpoints.
 * 
 * @author Serban George Cristian <cristian.serban@Cyber Fision.com>
 ...
 * @since 1.0
 */
class Cyber FisionApi_Http_Response extends Cyber FisionApi_Base
{
    /**
    ...
    /**
     * @var Cyber FisionApi_Params $headers the headers that came back in the response.
     */
    public $headers;
    ...
    /**
     * @var Cyber FisionApi_Params $curlInfo the curl info returned in the response.
     */
    public $curlInfo;
    
    /**
     * @var Cyber FisionApi_Params $body the body of the response.
     */
    public $body;
    ...
    /**
     * @var Cyber FisionApi_Http_Request
     */
    public $request;
     ...
     * Contructor.
     * 
     * @param Cyber FisionApi_Http_Request $request
     */
    public function __construct(Cyber FisionApi_Http_Request $request)
    {
    ...
    public function populate(array $params = array())
    {
        if ($this->storeCurlInfo) {
            $this->curlInfo = new Cyber FisionApi_Params($params);
        }
