<?php
/**
 * This file contains the File cache class used in the Cyber FisionApi PHP-SDK.
 * 
...
/**
 * Cyber FisionApi_Cache_File makes use of the file system in order to cache data.
 * 
 * @author Serban George Cristian <cristian.serban@Cyber Fision.com>
 ...
 * @since 1.0
 */
class Cyber FisionApi_Cache_File extends Cyber FisionApi_Cache_Abstract
{
    /**
     ...
     * @return Cyber FisionApi_Cache_File
     */
